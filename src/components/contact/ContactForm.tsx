...
export default function ContactForm() {
  ...
  return (
    <div className="w-full py-12 px-4 sm:px-6">
      ...
      >
        <h3 className="text-xl font-semibold mb-6 text-center">Or Drop A Message</h3>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-md border border-border bg-transparent focus:ring-2 focus:ring-primary focus:border-transparent"
              required
            />
          </div>
