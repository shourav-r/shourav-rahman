        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-md border border-border/50 bg-background/50 text-foreground focus:ring-2 focus:ring-primary focus:border-transparent placeholder:text-muted-foreground/70"
              required
            />
          </div>
